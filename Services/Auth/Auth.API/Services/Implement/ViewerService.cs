...
//         var Viewer = await _unitOfWork.GetRepository<UserRole>().SingleOrDefaultAsync(
...
//         bool isAsc)
//     {
//         var Viewers = await _unitOfWork.GetRepository<UserRole>().GetPagingListAsync(
//             selector: m => new UserRole()
//             {
//                 Id = m.Id,
//                 UserId = m.UserId,
//                 User = m.User,
...
//         _unitOfWork.GetRepository<UserRole>().UpdateAsync(Viewer);
