...
namespace Document.Domain.Migrations
{
    ...
    [Migration("20250822051628_AddReplacedByIdToDocumentFile")]
    partial class AddReplacedByIdToDocumentFile
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Document.Domain.Models.AIConfiguration", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Document.Domain.Model.DocumentFile", b =>
                {
                    ...
                    b.HasOne("Document.Domain.Model.DocumentFile", "ReplacedByDocument")
                        .WithMany()
            ...
            modelBuilder.Entity("Document.Domain.Models.DocumentVersion", b =>
                {
                    ...
                    b.HasOne("Document.Domain.Models.Folder", "TargetFolder")
                        .WithMany()
